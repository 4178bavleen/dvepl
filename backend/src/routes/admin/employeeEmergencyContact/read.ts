  ...
  fastify.get(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const contacts = await (fastify.prisma as any).employeeEmergencyContact.findMany({
          where: {
            deletedAt: null,
            employee: {
              companyId,
  ...
  fastify.get(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        const contact = await (fastify.prisma as any).employeeEmergencyContact.findFirst({
          where: {
            id,
            deletedAt: null,
            employee: {
