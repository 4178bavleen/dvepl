...
*/
-- CreateEnum
CREATE TYPE "TrackingStatus" AS ENUM ('PENDING', 'PARTIAL', 'RECEIVED', 'OVERDUE', 'CANCELLED');
...
-- AlterTable
ALTER TABLE "purchase_order_items" ADD COLUMN     "expectedDelivery" TIMESTAMP(3),
ADD COLUMN     "lastReceivedAt" TIMESTAMP(3),
ADD COLUMN     "trackingRemarks" TEXT,
